...
public final class CompareRoutePolicyStanzasQuestion extends Question{
    ...
    static final boolean DEFAULT_IGNORE_SUBSETS = Boolean.FALSE;
    ...
    public CompareRoutePolicyStanzasQuestion() { this(DEFAULT_DIRECTION, null, null, null); }
    ...
    private static CompareRoutePolicyStanzasQuestion jsonCreator(
        ...
        return new CompareRoutePolicyStanzasQuestion(
                firstNonNull(direction, DEFAULT_DIRECTION), policy, nodes, ignoreSubsets);
    }
